...
class Templar(Leaf):
    ...
    def description(self):
        return (
            'Um cavaleiro Templário devoto as leis de Deus. Ele fará de tudo\n'
...
class Paladin(Leaf):
    ...
    def description(self):
        return (
            'Um paladino se destaca pela sua força e resistência, podendo aguentar\n'
...
class Ninja(Leaf):
    ...
    def description(self):
        return (
            'Também chamado de demônio negro, esse é o ninja. Sempre faz seus ataques\n'
...
class StealthKiller(Leaf):
    ...
    def description(self):
        return (
            'Um assassino sabe aproveitar a distração do inimigo para atingi-lo em pontos vitais.\n'
...
class Fighter(Leaf):
    ...
    def description(self):
        return (
            'Um mestre na arte da luta sempre vai ser uma ótima escolha no campo de batalha. Caso ele\n'
