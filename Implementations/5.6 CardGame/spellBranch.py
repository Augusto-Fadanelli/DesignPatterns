...
class FireRain(Leaf):
    ...
    def description(self):
        return (
            'A melhor legião de elfos arqueiros junta-se para criar a tão temida chuva de flechas.\n'
...
class TrailOfDead(Leaf):
    ...
    def description(self):
        return (
            'Um poder tão forte nas mãos certas pode decidir o destino de uma batalha,\n'
