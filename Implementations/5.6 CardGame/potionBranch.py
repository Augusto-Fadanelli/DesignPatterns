...
class WeaknessPotion(Leaf):
    ...
    def description(self):
        return (
            'Uma poção que causa fraqueza em todos àqueles que beberem ou inalarem,\n'
...
class StrengthPotion(Leaf):
    ...
    def description(self):
        return (
            'Também conhecida como Força de Hércules, essa poção é\n'
...
class PoisonPotion(Leaf):
    ...
    def description(self):
        return (
            'Um veneno extraído da criatura mais perigosa do mundo, tão logo\n'
