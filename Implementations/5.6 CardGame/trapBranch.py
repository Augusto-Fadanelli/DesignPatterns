...
class MeteorRain(Leaf):
    ...
    def description(self):
        return (
            'Enormes rochas de fogo caem do céu e atingem o campo de batalha.\n'
...
class Necromancy(Leaf):
    ...
    def description(self):
        return (
            'A magia proibida está escrita no necromante, capaz de ressuscitar\n'
...
class AlternateReality(Leaf):
    ...
    def description(self):
        return (
            'Com este feitiço, o campo de batalha será movido.\n'
...
class Madness(Leaf):
    ...
    def description(self):
        return (
            'Faça seus inimigos matarem uns aos outros com essa carta,\n'
...
class Thorns(Leaf):
    ...
    def description(self):
        return (
            'Armadilha terrestre feita para capturar e matar seus inimigos distraídos.\n'
...
class LightStatue(Leaf):
    ...
    def description(self):
        return (
            'Essa estátua é capaz de cegar e desorientar seus adversários,\n'
