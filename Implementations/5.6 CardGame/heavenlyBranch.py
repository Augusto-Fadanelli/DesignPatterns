...
class DarkMagician(Leaf):
    ...
    def description(self):
        return (
            'Um mago que se rendeu as práticas do lado do mal, corrompendo-se por mais poder.\n'
...
class LightMagician(Leaf):
    ...
    def description(self):
        return (
            'Extremamente podereso, sábio e com boas intenções.\n'
...
class DarkSorcerer(Leaf):
    ...
    def description(self):
        return (
            'Um mago sombrio já pode ser um problema no seu caminho, mas um feiticeiro\n'
...
class LightSorcerer(Leaf):
    ...
    def description(self):
        return (
            'Feiticeiros nascem com o dom da magia, diferente dos magos. Seu poder\n'
...
class ShapeshifterElf(Leaf):
    ...
    def description(self):
        return (
            'Metamorfos são uma espécie de elfo Negro, que possuem a habilidade de se transformar em Animais.\n'
...
class ElfArcher(Leaf):
    ...
    def description(self):
        return (
            'Exímios atiradores no uso do arco, sua determinação a uma única arma destacam eles como grandes guerreiros.\n'
