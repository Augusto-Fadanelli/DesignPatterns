...
class ConcreteVisitor1(Visitor):
    def visitConcreteComponentA(self, element):
        print(
            f'{element.exclusiveMethodOfConcreteComponentA()} + ConcreteVisitor1'
        )

    def visitConcreteComponentB(self, element):
        print(
            f'{element.specialMethodOfConcreteComponentB()} + ConcreteVisitor1'
        )
...
class ConcreteVisitor2(Visitor):
    def visitConcreteComponentA(self, element):
        print(
            f'{element.exclusiveMethodOfConcreteComponentA()} + ConcreteVisitor2'
        )

    def visitConcreteComponentB(self, element):
        print(
            f'{element.specialMethodOfConcreteComponentB()} + ConcreteVisitor2'
        )
